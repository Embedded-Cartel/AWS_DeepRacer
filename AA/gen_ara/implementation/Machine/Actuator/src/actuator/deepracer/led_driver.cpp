...
namespace PWM {
    ...
    int LedDriver::setLedValue(int red_value, int green_value, int blue_value) {
    ...
    int LedDriver::getLedValue(int *red_value, int *green_value, int *blue_value) {
    ...
    int LedDriver::setLedValFromFile(std::unordered_map<std::string, int> &ledValuesMap, const std::string &filePath) {
    ...
    int LedDriver::writeLedValJSON(std::unordered_map<std::string, int> &ledValuesMap, const std::string &filePath) {
